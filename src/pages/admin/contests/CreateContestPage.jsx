    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <div className="relative z-[1]">
        ...
        <main className="mx-auto max-w-7xl px-6 py-8 pb-20">
          ...
          {/* Added a 2-column Grid Layout */}
          <form className="grid grid-cols-1 gap-6 lg:grid-cols-3" onSubmit={(e) => e.preventDefault()}>
            
            {/* ── Left Column: General Info & Problems (Takes up 2/3 space) ── */}
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea rows={6} placeholder="Describe the contest rules..." className={`resize-none ${inputClasses}`} />
                  </div>
                </div>
              </div>
                  ...
                  {filteredProblems.map((p) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`flex cursor-pointer items-center justify-between border-b border-slate-100 p-3.5 last:border-0 transition hover:bg-slate-50 ${isSelected ? "bg-amber-50/30" : ""}`}
                      >
                        <div>
                        ...
                        <div className={`flex h-5 w-5 items-center justify-center rounded border transition ${isSelected ? "border-amber-500 bg-amber-500 text-white" : "border-slate-300 bg-white"}`}>
            ...
            {/* ── Right Column: Settings & Actions (Takes up 1/3 space) ── */}
            <div className="space-y-6 lg:col-span-1">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 rounded-xl border p-3 transition ${!isPrivate ? "border-amber-400 bg-amber-50 text-amber-700" : "border-slate-200 text-slate-500 hover:bg-slate-50"}`}
                  >
                ...
                {isPrivate && (
                  <div className="mt-4 animate-[fadeSlideDown_0.2s_ease]">
                    ...
                    <input type="password" placeholder="Enter password..." className={inputClasses} />
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-col gap-3 pt-2">
                <button type="submit" className="w-full rounded-xl bg-amber-600 px-6 py-3 text-[14px] font-semibold text-white transition hover:bg-amber-700 shadow-sm">
                  Create Contest
                </button>
                <Link to="/admin/dashboard" className="w-full text-center rounded-xl border border-slate-200 px-6 py-3 text-[14px] font-medium text-slate-600 transition hover:bg-slate-50">
                  Cancel
                </Link>
              </div>
